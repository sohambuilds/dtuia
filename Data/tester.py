...
if __name__ == "__main__":
    ...
    if algo in graph_based:
        ...
        # Fix path to work from root directory
        if os.path.exists("json_testcases"):
            json_path = "json_testcases/" + algo + ".json"
        else:
            json_path = "Data/json_testcases/" + algo + ".json"
        
        working_file = open(json_path, 'r')
